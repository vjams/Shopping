...
INSERT INTO `Seller` (`Seller_id`, `Name`, `Website`) VALUES
...
INSERT INTO `items` (`item_id`, `name`, `seller`, `publisher`, `genre`, `price`, `review`, `age_limit`, `release_date`, `except_country`, `description`) VALUES
...
INSERT INTO `orders` (`order_id`, `user_id`, `item_id`, `price`, `payment_id`, `date`) VALUES
...
ALTER TABLE `items`
  ADD CONSTRAINT `seller_id` FOREIGN KEY (`seller`) REFERENCES `seller` (`seller_id`),
